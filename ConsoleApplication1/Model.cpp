...
Model::Model(ShaderProgram* shaderProgram, const float* points, int arraySize, int vertexCount, GLenum drawMode, const std::string& type, Material* material, int id, Texture* texture)
	: DrawableObject(shaderProgram, type), drawMode(drawMode), vertexCount(vertexCount),  id(id), material(material), texture(texture) {
...
Model::Model(const char* path, ShaderProgram* shaderProgram, Material* material, Texture* texture, const std::string& type, int id)
	: DrawableObject(shaderProgram, type), id(id), material(material), texture(texture) {
